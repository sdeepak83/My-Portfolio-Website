...
const Footer = () => {
    return (
        <div className=' bg-white'>
            <div className='flex flex-col items-center gap-3 border-t-2 border-black w-full pt-10 font-semibold'>
                <h1>Design and developed by-</h1>
                <h1 className=' text-purple-600'>Deepak Singh</h1>
            </div>
            ...
            <div className="max-w-3xl mx-auto  mt-5">
                <div className="flex flex-col justify-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-5 m-2 md:justify-around">
